...
#nullable disable
#nullable restore
#line 37 "C:\Users\jonsi\ASP.NETProjects\treyd\treyd\treyd\_Imports.razor"
...
#nullable restore
#line 49 "C:\Users\jonsi\ASP.NETProjects\treyd\treyd\treyd\Components\Payment.razor"
    ...
    private QuickPayHandler QuickPayHandler = new QuickPayHandler();
    private List<Payment> Payments = new List<Payment>();

    protected override async Task OnInitializedAsync()
    {
        Payments = await QuickPayHandler.GetPayments();
    }
    ...
    private async Task CreatePayment()
    {
        ...
        CreatePaymentVariables.Add("userId", "RuniTH");

        Payment payment = await QuickPayHandler.CreatePayment("dkk", "1232", CreatePaymentVariables);

        PaymentLinkUrl paymentLink = await QuickPayHandler.CreateOrUpdatePaymentLink(
            payment.Id, 100, false, "en", "PaymentCompleted", "");

        NavigationMananager.NavigateTo(paymentLink.Url);
    }

    private async Task CancelSubscription()
    {
        await QuickPayHandler.CancelSubscription(123);
    }

#line default
#line hidden
#nullable disable
        [global::Microsoft.AspNetCore.Components.InjectAttribute] private NavigationManager NavigationMananager { get; set; }
    }
}
